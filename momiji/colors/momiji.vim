...
highlight CursorLineFold guibg=#5a4e4e ctermbg=236
...
highlight CurSearch guifg=#140c0c ctermfg=0 guibg=#69b2ac ctermbg=14
...
" Diagnostics
"
highlight DiagnosticFloatingHint guifg=#5a4e4e ctermfg=236
highlight DiagnosticHint guifg=#5a4e4e ctermfg=236
highlight DiagnosticSignHint guifg=#5a4e4e ctermfg=236
highlight DiagnosticUnderlineHint guifg=#5a4e4e ctermfg=236
highlight DiagnosticVirtualTextHint guifg=#5a4e4e ctermfg=236
highlight DiagnosticFloatingInfo guifg=#4884d2 ctermfg=4
highlight DiagnosticInfo guifg=#4884d2 ctermfg=4
highlight DiagnosticSignInfo guifg=#4884d2 ctermfg=4
highlight DiagnosticUnderlineInfo guifg=#4884d2 ctermfg=4
highlight DiagnosticVirtualTextInfo guifg=#4884d2 ctermfg=4
highlight DiagnosticError guifg=#da5774 ctermfg=1
highlight DiagnosticFloatingError guifg=#da5774 ctermfg=1
highlight DiagnosticSignError guifg=#da5774 ctermfg=1
highlight DiagnosticUnderlineError guifg=#da5774 ctermfg=1
highlight DiagnosticVirtualTextError guifg=#da5774 ctermfg=1
highlight DiagnosticFloatingWarn guifg=#e7a82b ctermfg=3
highlight DiagnosticSignWarn guifg=#e7a82b ctermfg=3
highlight DiagnosticUnderlineWarn guifg=#e7a82b ctermfg=3
highlight DiagnosticVirtualTextWarn guifg=#e7a82b ctermfg=3
highlight DiagnosticWarn guifg=#e7a82b ctermfg=3
